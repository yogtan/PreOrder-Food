    ...
    <section class="container px-5 mt-5 py-2 mx-auto">
        ...
        <div id="bannerPenjual" class="border mx-auto rounded-1 border bg-white d-flex shadow-1 mt-3">
            <div id="placeHolder" class="mx-auto my-auto text-center">
                ...
                <input type="file" id="file" name="header" class="border rounded-1 start-0 top-0" accept="image/*">    
            </div>
        </div>
            ...
            <div id="profilePicture" class=" my-2">
                ...
                <div class="d-flex justify-content-center items-center my-3">
                    <div class="me-2">
                        ...
                        <input type="text" name="nama_bank" placeholder="Nama Bank" class="rounded-1 ps-2 fs-5 d-block mb-3" style="width:100%; height:40px;">
                        <input type="text" name="rekening" placeholder="password" class="rounded-1 ps-2 fs-5 d-block mb-3" style="width:100%; height:40px;">
                        ...
                        <textarea name="deskripsi" id="deskripsiToko" cols="60" rows="5" placeholder="deskripsi toko" class="rounded-1 p-2 fs-5"></textarea>
                    </div>
                </div>
            </div>
